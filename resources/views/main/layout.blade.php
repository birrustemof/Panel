...
<head>
    ...
    <link
        ...
        crossorigin="anonymous"
    />
    {{-- <link rel="stylesheet" href="{{ asset('css/adminlte.css') }}" /> --}} <link rel="stylesheet" href="{{ asset('css/adminlte-map.css') }}" /> <link
        rel="stylesheet"
        ...
        <div class="sidebar-wrapper">
            <nav class="mt-2">
                <ul
                    ...
                    id="navigation"
                >
                    {{-- DÜZGÜN KOD (Dinamik) acdivate  --}}
                    <li class="nav-item {{ request()->is('/') || request()->is('index2') || request()->is('index3') ? 'menu-open' : '' }}">
                        <a href="#" class="nav-link {{ request()->is('/') || request()->is('index2') || request()->is('index3') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ url('index2') }}" class="nav-link {{ request()->is('index2') ? 'active' : '' }}">
                                    <i class="nav-icon bi bi-circle"></i>
                                    <p>Dashboard v2</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ url('index3') }}" class="nav-link {{ request()->is('index3') ? 'active' : '' }}">
                                    <i class="nav-icon bi bi-circle"></i>
                                    <p>Dashboard v3</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('muellif.add') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('muellif.list') }}" class="nav-link">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (connectedSortables.length > 0) {
            connectedSortables.forEach(list => {
                new Sortable(list, {
                    group: 'shared',
                    handle: '.card-header',
                });
        ...
        if (document.getElementById('world-map') && typeof jsVectorMap !== 'undefined') {
            new jsVectorMap({
                selector: '#world-map',
                map: 'world', // Assumes 'world.js' is loaded
            });
        }

        // ApexCharts - Sparkline Charts
